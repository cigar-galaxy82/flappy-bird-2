...
//BACKGROUND
// const bg = {//FROM THIS OBJECT THINGS ARE COMING UNDEFINED
//     sX : 0,
//     sY : 0,
//     w : 275,
//     h : 226,
...
const pipes = {
    ...
    update: function(){
        ...
        for(let i=0;i<this.position.length;i++){
            ...
            //if pipe goes beyond canvas, we deletethem from the array
            if(p.x + this.w <= 0){
                this.position.shift()
                score.value += 1;
                SCORE_S.play()
...
const score = {
    ...
    draw: function(){
        ...
        if(state.current == state.game){
            ...
            //SCORE VALUE
            ctx.font = "25px Teko"
            ctx.fillText(this.value, 225, 173)
            ctx.strokeText(this.value, 225, 173)
            //BEST SCORE
